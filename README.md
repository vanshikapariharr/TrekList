TrekList
TrekList is a modern, minimal to-do list application designed for trekking, travel, and packing workflows. It helps users organize items efficiently with a clean user interface and powerful bulk actions.
...
Zustand manages the core application state, including items and bulk actions, in a simple and predictable store.
...
Author
Vanshika Parihar
GitHub: https://github.com/vanshikapariharr
